# Pedidos — Jess (Ona Dance)

Fonte: painel Nexo Workspace (org Ona Dance). Feitos ✓ / Em aberto ○:
- ○ Slider→vídeo do hero (CLIENT_REVIEWING) — IMPLEMENTADO em pre2.onadance.com; falta aprovação dela + publicação + ajuste full-bleed desktop.
